...
<div class="example-block" style="border-color: var(--border-tertiary-night-eye); border-left-width: 2px; color: var(--text-secondary); font-size: 0.875rem; margin-bottom: 1rem; margin-top: 1rem; overflow: visible; padding-left: 1rem;" ne="0.3898945043399602">
...
<div class="example-block" style="border-color: var(--border-tertiary-night-eye); border-left-width: 2px; color: var(--text-secondary); font-size: 0.875rem; margin-bottom: 1rem; margin-top: 1rem; overflow: visible; padding-left: 1rem;" ne="0.9649178328209125">
<p><strong>Input:</strong> <span class="example-io" style="
    font-family: Menlo,sans-serif;
    font-size: 0.85rem;
...
<div class="example-block" style="border-color: var(--border-tertiary-night-eye); border-left-width: 2px; color: var(--text-secondary); font-size: 0.875rem; margin-bottom: 1rem; margin-top: 1rem; overflow: visible; padding-left: 1rem;" ne="0.46837698072202105">
<p><strong>Input:</strong> <span class="example-io" style="
    font-family: Menlo,sans-serif;
    font-size: 0.85rem;
...
<p><span style="color: var(--text-secondary); font-size: 0.875rem;" ne="0.008366168839289978">The maximum score achievable is </span><code style="color: var(--text-secondary); font-size: 0.875rem;" ne="0.06539707141589379">2</code><span style="color: var(--text-secondary); font-size: 0.875rem;" ne="0.2495075675072289">.</span></p>
</div>
